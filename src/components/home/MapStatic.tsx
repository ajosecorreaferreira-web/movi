    ...
    <div style={{
      ...
      <div style={{
        ...
        >
          ...
          {/* Zona forestal principal */}
          <ellipse cx="170" cy="125" rx="165" ry="120" fill="#D4E6C3"/>

          {/* Sombra/gradiente interior del pinar */}
          ...
          {/* Camino principal del pinar */}
          <path
            d="M 20 160 Q 80 140 140 150 Q 190 158 230 140 Q 270 125 300 130"
            stroke="#C8B89A"
            strokeWidth="4"
            fill="none"
            strokeLinecap="round"
          ...
          {/* Camino secundario */}
          <path
            d="M 50 90 Q 110 100 160 90 Q 200 82 240 70"
            stroke="#C8B89A"
            strokeWidth="2.5"
            fill="none"
            strokeLinecap="round"
          ...
          {/* Zona de máquinas al aire libre */}
          ...
          {/* Línea discontinua centro de la calle */}
