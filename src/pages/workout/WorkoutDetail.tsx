...
import { MOCK_WORKOUT_BLOCKS, type WorkoutBlock } from './workoutData'
      ...
      >
        ...
        >
          <svg width="18" height="18" viewBox="0 0 18 18">
            <circle cx="4" cy="9" r="2" fill="var(--color-text)" />
            <circle cx="9" cy="9" r="2" fill="var(--color-text)" />
            <circle cx="14" cy="9" r="2" fill="var(--color-text)" />
          </svg>
        </button>
      </header>
              ...
              >
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                    {/* Toggle Lista/Timeline — solo si expandido */}
                    {isExpanded && (
                      <>
                        <button
