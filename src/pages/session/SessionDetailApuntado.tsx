...
export default function SessionDetailApuntado() {
  const navigate = useNavigate()
  const { haptic } = useHaptics()

  const handleDesapuntarme = () => {
    haptic('medium')
    navigate('/home')
  }
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div style={{
            ...
            <span style={{ color: 'var(--color-success-text)', fontFamily: 'var(--font-sans)', fontSize: 11, fontWeight: 700, lineHeight: '16px' }}>
              Apuntado
            </span>
          </div>
        </div>
      ...
      <div style={{ backgroundColor: 'var(--color-surface)', padding: 20, display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ position: 'relative', padding: '12px 16px 8px 20px', borderRadius: 10 }}>
          <span style={{ position: 'absolute', top: 4, left: 10, fontFamily: 'Georgia, serif', fontSize: 24, fontWeight: 700, color: 'var(--color-primary)', opacity: 0.7, lineHeight: '100%' }}>"</span>
          <p style={{ paddingTop: 10, color: 'var(--color-text-muted)', fontFamily: 'var(--font-sans)', fontSize: 14, fontStyle: 'italic', lineHeight: '22px', textAlign: 'center', margin: 0 }}>
            Ven, soy puntual y a divertirse.<br />Puedes seguirme o hacer tu rutina.
          </p>
          <span style={{ display: 'block', textAlign: 'right', marginTop: 4, fontFamily: 'Georgia, serif', fontSize: 24, fontWeight: 700, color: 'var(--color-primary)', opacity: 0.7, lineHeight: '50%' }}>"</span>
        </div>
      </div>
      ...
      <div style={{ backgroundColor: 'var(--color-surface)', borderTop: '1px solid var(--color-border)', padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            <span style={{ color: 'var(--color-text)', fontFamily: 'var(--font-sans)', fontSize: 15, fontWeight: 600, lineHeight: '20px' }}>3 personas apuntadas</span>
            <span style={{ color: 'var(--color-text-muted)', fontFamily: 'var(--font-sans)', fontSize: 13, lineHeight: '18px' }}>también irán esta semana</span>
          </div>
        </div>
        <div style={{ backgroundColor: 'var(--color-primary-50)', borderRadius: 8, padding: '10px 14px', display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ color: 'var(--color-primary-text)', fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 600, lineHeight: '20px' }}>Quedan 5 plazas</span>
        </div>
      </div>
      ...
      <div style={{ backgroundColor: 'var(--color-surface)', marginTop: 8, display: 'flex', flexDirection: 'column' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 20px', borderBottom: '1px solid var(--color-border)' }}>
          <div style={{ width: 32, height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <svg width="20" height="20" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" fill="none" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><polyline points="12 6 12 12 16 14" fill="none" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
          </div>
          ...
          <div style={{ width: 32, height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <svg width="20" height="20" viewBox="0 0 24 24"><line x1="18" y1="20" x2="18" y2="10" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><line x1="12" y1="20" x2="12" y2="4" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><line x1="6" y1="20" x2="6" y2="14" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
          </div>
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 20px', borderBottom: '1px solid var(--color-border)' }}>
          <div style={{ width: 32, height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <svg width="20" height="20" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" fill="none" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><circle cx="12" cy="10" r="3" fill="none" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
          </div>
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 1 }}>
          ...
          <span style={{ color: 'var(--color-primary-text)', fontFamily: 'var(--font-sans)', fontSize: 13, fontWeight: 600, lineHeight: '16px', flexShrink: 0 }}>350m de ti</span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 20px', borderBottom: '1px solid var(--color-border)' }}>
          <div style={{ width: 32, height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <svg width="20" height="20" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" fill="none" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><line x1="16" y1="2" x2="16" y2="6" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><line x1="8" y1="2" x2="8" y2="6" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><line x1="3" y1="10" x2="21" y2="10" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
          </div>
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 20px', borderBottom: '1px solid var(--color-border)' }}>
          <div style={{ width: 32, height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <svg width="20" height="20" viewBox="0 0 24 24"><circle cx="12" cy="5" r="1" fill="none" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M9 20l3-15 3 15" fill="none" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M6 13h12" fill="none" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
          </div>
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 1 }}>
      ...
      <div style={{ backgroundColor: 'var(--color-surface)', marginTop: 8, padding: 20 }}>
        <div style={{ backgroundColor: 'var(--color-primary-50)', borderLeft: '6px solid var(--color-primary)', borderRadius: '0 6px 6px 0', padding: 16, display: 'flex', flexDirection: 'column', gap: 12 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <svg width="20" height="20" viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" fill="none" stroke="var(--color-primary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
            <span style={{ color: 'var(--color-text)', fontFamily: 'var(--font-sans)', fontSize: 16, fontWeight: 700, lineHeight: '22px' }}>Funcional avanzado</span>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: 8, borderTop: '1px solid var(--color-primary-100)' }}>
            <span style={{ color: 'var(--color-primary-text)', fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 600, lineHeight: '20px' }}>Ver detalle del entrenamiento</span>
            <svg width="16" height="16" viewBox="0 0 24 24"><path d="M9 18l6-6-6-6" fill="none" stroke="var(--color-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24">
            <polyline points="20 6 9 17 4 12" fill="none" stroke="var(--color-success)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          Desapuntarme
        </button>
      </div>
